...
public class Fitness_Lesson {

    private static Fitness_Lesson instance;


    public static synchronized Fitness_Lesson getInstance() {
        if (instance == null) {
            instance = new Fitness_Lesson();
        }
        return instance;
    }
